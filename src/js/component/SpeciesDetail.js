    ...
    <div className="wholecard w-100 card container-fluid mx-auto" style={{maxWidth:"40rem"}}>
        {!data?
         ...
         Loading...
          ...
          <h1 className="d-flex justify-content-center align-items-center text-center m-5">{data.name}</h1>
          <ul className="list-group list-group-flush">
          <img className="mx-auto px-auto img-fluid rounded mb-3" src={data.img} onError={imgError}></img>
              <li className="list-group-item rounded mb-1"><p><strong>Eye Color: </strong>{data.eye_colors}</p></li>
              <li className="list-group-item rounded my-1"><strong>Hair Color: </strong>{data.hair_colors}</li>
              <li className="list-group-item rounded my-1"><strong>Classification: </strong>{data.classification}</li>
              <li className="list-group-item rounded my-1"><strong>Designation: </strong>{data.designation}</li>
              <li className="list-group-item rounded my-1"><strong>Average Height: </strong>{data.average_height}</li>
              <li className="list-group-item rounded my-1"><strong>Average Lifespan: </strong>{data.average_lifespan}</li>
              <li className="list-group-item rounded mt-1"><strong>Language: </strong>{data.language}</li>
              <h1 className="d-flex justify-content-center align-items-center text-center m-5">Home Planet:</h1>
